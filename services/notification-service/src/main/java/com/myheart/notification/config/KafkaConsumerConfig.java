...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AppointmentEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.myheart.common.events");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.myheart.common.events.AppointmentEvent");
